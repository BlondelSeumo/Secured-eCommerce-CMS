                    ...
                    <form class="form-horizontal" action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select name="timezone" class="form-control aiz-selectpicker" data-live-search="true" data-selected="{{ config('app.timezone') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select name="weight_unit" class="form-control aiz-selectpicker" data-live-search="true" data-selected="{{ get_setting('weight_unit') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select name="dimension_unit" class="form-control aiz-selectpicker" data-live-search="true" data-selected="{{ get_setting('dimension_unit') }}">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-control bg-soft-secondary">{{ get_setting('force_cache_clear_version') }}</div>
                                <input type="hidden" name="types[]" value="force_cache_clear_version">
                                <input type="hidden" name="force_cache_clear_version" class="form-control" value="{{ strtolower(Str::random(30)) }}">
                            </div>
                        </div>
                        <div class="text-right">
                        ...
                        <div class="form-group row">
							...
							<div class="col-md-8">
			                    <div class=" input-group " data-toggle="aizuploader" data-type="image">
			                        ...
			                        <input type="hidden" name="customer_chat_logo" class="selected-files" value="{{ get_setting('customer_chat_logo') }}">
			                    </div>
		                ...
		                <div class="form-group row">
							...
							<div class="col-md-8">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="" name="customer_chat_name" value="{{ get_setting('customer_chat_name') }}">
								</div>
							</div>
						</div>
                        <div class="text-right">
                    ...
                    <form class="form-horizontal" action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
							...
							<div class="col-md-8">
			                    <div class=" input-group " data-toggle="aizuploader" data-type="image">
			                        ...
			                        <input type="hidden" name="invoice_logo" class="selected-files" value="{{ get_setting('invoice_logo') }}">
			                    </div>
			                    <div class="file-preview"></div>
							</div>
		                </div>
                        <div class="form-group row">
							...
							<div class="col-md-8">
                                ...
                                <input type="text" class="form-control" placeholder="{{ translate('Address') }}" name="invoice_address" value="{{ get_setting('invoice_address') }}">
                            </div>
                        </div>
                        <div class="form-group row">
							...
							<div class="col-md-8">
                                ...
                                <input type="text" class="form-control" placeholder="{{ translate('Email') }}" name="invoice_email" value="{{ get_setting('invoice_email') }}">
                            </div>
                        </div>
                        <div class="form-group row">
							...
							<div class="col-md-8">
                                ...
                                <input type="text" class="form-control" placeholder="{{ translate('Phone') }}" name="invoice_phone" value="{{ get_setting('invoice_phone') }}">
                            </div>
                        </div>
                        <div class="text-right">
      						<button type="submit" class="btn btn-primary">{{ translate('Update') }}</button>
